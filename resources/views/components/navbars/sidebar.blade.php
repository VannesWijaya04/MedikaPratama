...
<aside
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0 d-flex text-wrap align-items-center" href=" {{ route('kehadirans.index') }} ">
            <img src="{{ asset('assets') }}/img/logo-klinik-medika.png" class="navbar-brand-img h-100" alt="main_logo">
            <span class="ms-2 font-weight-bold text-white">Absensi Klinik Medika Pratama</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'kehadirans' ? ' active bg-gradient-primary' : '' }} "
                    href="/kehadirans">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'lemburs' ? ' active bg-gradient-primary' : '' }} "
                    href="/lemburs">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">receipt_long</i>
                    </div>
            ...
            <!-- Route to karyawan -->
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'karyawans' ? ' active bg-gradient-primary' : '' }} "
                    href="/karyawans">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            @if (Auth::user()->level == 'A')
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'statusKehadirans' ? ' active bg-gradient-primary' : '' }} "
                    href="/statusKehadirans">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">table_view</i>
                    </div>
                    <span class="nav-link-text ms-1">Tambah Status Kehadiran</span>
                </a>
            </li>
            @endif
