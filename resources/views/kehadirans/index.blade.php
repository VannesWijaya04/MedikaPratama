<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage="Kehadiran"></x-navbars.navs.auth>
        <!-- End Navbar -->
        ...
        <div class="card my-4">
            ...
            @if (Auth::user()->level == 'A')
                <button type="button" onclick="window.location='{{ url('/attendance-check') }}'"
                    class="btn btn-primary">Otomatis Alpha</button>
                <h5>Data Alpha Karyawan Hari ini</h5>
                <table>
                    <thead>
                        <tr>
                            <th>Nama Karyawan</th>
                    ...
                    @if (isset($kehadiran_hari_inis))

                        <tbody>
                            @foreach ($kehadiran_hari_inis as $attendance)
                                <tr>
            ...
            @if (Auth::user()->level == 'U')
                <div class="card-body px-0 pb-2">
                    <a href="{{ route('kehadirans.create') }}"
                        class="btn btn-primary mx-3 pt-4 pb-3 color:white">ABSEN</a>


                    <form method="GET" action="{{ route('kehadirans.index') }}" class="mx-3 pt-4 pb-3">
                        ...
                        <br>
                        <br>
                        <button type="submit" class="btn btn-primary">Tampilkan Data Absensi</button>
                    </form>
                                    ...
                                    @if ($items->level != 'I')
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm">{{ $items->keterangan }}</h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
